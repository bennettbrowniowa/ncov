...
# [Передача на территории США является комлексной и недостаточно изученной](https://nextstrain.org/ncov/2020-03-27?d=tree,map&f_division=Connecticut&label=clade:B1&m=div&p=full)
...
Несмотря на то что требуется больше данных чтобы сделать конкретные выводы, это говорит о недавней передаче даже между весьма удаленными частями страны. 
<br><br>
Это подчеркивает тот факт, что пути передачи на територии США куда более сложные, чем представленно в доступных данных. 
